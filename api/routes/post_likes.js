...
router.post('/countPostLikes',check_auth, likes_controler.countPostLikes)
/*************************************************************/
...
router.post('/countPostCommentsLikes',check_auth, likes_controler.countPostCommentsLikes)
